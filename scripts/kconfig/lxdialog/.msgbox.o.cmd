cmd_scripts/kconfig/lxdialog/msgbox.o := gcc -Wp,-MD,scripts/kconfig/lxdialog/.msgbox.o.d    -DCURSES_LOC="<ncurses.h>" -DLOCALE    -c -o scripts/kconfig/lxdialog/msgbox.o scripts/kconfig/lxdialog/msgbox.c
