...
# installed.
TK_PREFIX='/usr/cross/arm-elf'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/usr/cross/arm-elf'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/usr/src/insight/arm-elf/tk/unix -ltk8.4'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/usr/cross/arm-elf/lib -ltk8.4'
...
# compiled.
TK_SRC_DIR='/usr/src/insight/insight-6.6/tk'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/usr/src/insight/arm-elf/tk/unix -ltkstub8.4'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/usr/cross/arm-elf/lib -ltkstub8.4'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/usr/src/insight/arm-elf/tk/unix/libtkstub8.4.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/usr/cross/arm-elf/lib/libtkstub8.4.a'
